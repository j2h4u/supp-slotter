...
9. Treat broad effect axes as reviewer selectors only. Do not use broad axes such as `bone_mineral_metabolism_support` or `neuromuscular_function_support` as relation endpoints without first narrowing the model.
